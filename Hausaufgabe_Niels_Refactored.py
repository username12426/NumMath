...
if __name__ == "__main__":
    ...
    def getAl(parameters, indexes, solution_vector):
        # h values
        h_2D = geth(parameters)[1]
        ...
        w = A.dot(solution_vector[:2 * parameters.n + 2])
        ...
        w_inserted = solution_vector[:2 * parameters.n + 2]
    ...
    Al = getAl(params, idx_19, alpha_e_static_solution_n3_arr)
    print(Al.toarray()*125)
